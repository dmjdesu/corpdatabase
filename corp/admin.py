...
from .models import (
    IndustryCategory, Industry, IndustrySubcategory, IndustryDetail,
    OriginIndustryCategory, OriginIndustry, TagCategory, TagSubcategory,
    TagSmallcategory, Company, Contact, Note, Prefecture, City
)
...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('name', 'industry_detail', 'origin_industry', 'city', 'state', 'country')
