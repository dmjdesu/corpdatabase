...
from corp.models import IndustryCategory, Industry, IndustrySubcategory, IndustryDetail
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Successfully loaded industry categories and industries'))
        except KeyError as e:
            self.stdout.write(self.style.ERROR(f"KeyError: {e} - Check CSV column headers"))
